...
const Gallery = () => {
    return ( 
        <div className="galleryContainer">
                ...
                <div className="box c"><img src={require('./img/3.jpeg')} alt="imagen de uñas"></img></div>
                <div className="box d"><img src={require('./img/4.jpeg')} alt="imagen de uñas"></img></div>
                <div className="box e"><img src={require('./img/5.jpeg')} alt="imagen de uñas"></img></div>
                <div className="box f"><img src={require('./img/6.jpeg')} alt="imagen de uñas"></img></div>
                <div className="box g"><img src={require('./img/7.jpeg')} alt="imagen de uñas"></img></div>
                <div className="box h"><img src={require('./img/8.jpeg')} alt="imagen de uñas"></img></div>
                <div className="box i"><img src={require('./img/9.jpeg')} alt="imagen de uñas"></img></div>
